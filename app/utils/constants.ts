...
export const MERMAID_CONFIG = {
  ...
  flowchart: { 
    curve: "linear",
    nodeSpacing: 80,  // Increased from default 50 for better spacing between nodes on same level
    rankSpacing: 100, // Increased from default 50 for better spacing between different levels
  },
  themeVariables: {
